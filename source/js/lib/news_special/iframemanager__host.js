    ...
    var iframeManager = {
        ...
        renderIframe: function () {
            var link   = document.getElementById('<%= iframeUid %>'),
                pathToContent = this.getPathToContent(link.href),
                iframe = new IframeWatcher(pathToContent, link.parentNode.className, link.getAttribute('data-static-iframe-height'));
