...
// *************************************************************************
// DEBUG MODE
// Setting this to true will make the page use seperate .js files
// *************************************************************************
...
module.exports = function (grunt) {
    grunt.initConfig({
        ...
        copy: {
            ...
            stageDeploy: {
                files: [
                    {expand: true, cwd: 'tmp', src: ['**'], dest: '/private/tmp/mounts/wwwlive/news/special/<%= pkg.year %>/newsspec_<%= pkg.project_number %>'}
                ]
            },
            liveDeploy: {
                files: [
            ...
            default: {
                options: {
                    ...
                    data: {
                        ...
                        //path:                '<%= env.vm.domain %>/news/special/<%= pkg.year %>/newsspec_<%= pkg.project_number %>',
                        //pathStatic:          '<%= env.vm.domainStatic %>/news/special/<%= pkg.year %>/newsspec_<%= pkg.project_number %>',
